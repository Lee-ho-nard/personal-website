...
- **Card padding:** 30px
- **Element gap:** 19px
- **Zigzag gap:** 360px (`--zigzag-gap`) — the gap before every `.zigzag` section after the first; deliberately well beyond the normal section-gap range, for scroll-linked orb weave room (see Zigzag Section Alternation)
